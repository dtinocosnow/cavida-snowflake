...
df=session.sql("""SELECT description AS "Descrição",tier AS "Tier",value AS "Valor",origin AS "Origem" FROM CAVIDA_DEMO.GOLD.SLV2_AVAILABLE_CAPITAL WHERE reference_date='2025-06-30' ORDER BY description,tier""").to_pandas()
