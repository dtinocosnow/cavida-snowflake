...
df=session.sql("""SELECT process_name AS "Processo",description AS "Descrição",status AS "Status",loaded_at AS "Data",row_count AS "Registos" FROM CAVIDA_DEMO.BRONZE.SLV2_CA_GESTL_FILES WHERE reference_date='2025-06-30' ORDER BY file_id""").to_pandas()
def cs(v):
