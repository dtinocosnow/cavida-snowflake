...
df=session.sql("""SELECT file_name AS "Ficheiro",file_size_kb||' KB' AS "Tamanho",generated_at AS "Gerado em",status AS "Estado" FROM CAVIDA_DEMO.BRONZE.SLV2_RISK_AGILITY_FILES WHERE reference_date='2025-06-30' AND direction='Download' ORDER BY file_id""").to_pandas()
